...
- Ночью в 00:15 МСК крон гонит `api_cli.py sync`: перезабор swagger и автопуш в `main` обоих репо (снапшоты в пайплайн, справочник и пин сюда). Незакоммиченные правки в дереве прогон отменяют — не оставляй их на ночь.
