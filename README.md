...
| [examples/](examples/) | примеры запросов/ответов по сервисам, вынесены из endpoints/ (генерируется из swagger) | нужен образец тела запроса/ответа конкретной ручки |
